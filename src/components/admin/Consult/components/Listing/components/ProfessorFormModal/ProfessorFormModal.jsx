...
export const ProfessorFormModal = ({ isVisible, onClose, onSubmit, professor }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    secondLastName: professor?.user.second_last_name || '',
    phone: professor?.user.phone || '',
    email: professor?.user.email || '',
    campusId: professor?.campus.id || '',
    academicDegreeId: professor?.degree.id || '',
    appointmentTypeId: professor?.appointment.id || '',
    tecCategoryId: professor?.category.id || '',
    positionId: professor?.position.id || '',
    roleIds: professor?.user.roles?.map(role => role.id) || [],
